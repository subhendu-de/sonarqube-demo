...
$QualityGateResult = Invoke-RestMethod -Method Get -Uri "http://$SonarServerName/api/qualitygates/project_status?projectKey=$SonarProjectKey&branch=$Branch" -Headers $Headers
